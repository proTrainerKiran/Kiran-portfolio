...
function EnquireyForm() {
  return (
    <div style={{ backgroundColor: '#1b0a03', fontFamily: 'Neohead', color: 'white', textAlign: 'center' }}>
      <div style={{ padding: '20px' }}></div>
        ...
        <p style={{ fontSize: '18px', fontWeight: '400', lineHeight: '1.5', letterSpacing: '0.02em', textAlign: 'center', margin: '20px 0' }}>
